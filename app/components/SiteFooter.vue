  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> 2055555.xyz </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/Kevin-Y-Du/site-statuk",
  home: "https://2055555.xyz",
  email: "mailto:kevin@2055555.xyz",
};
</script>
